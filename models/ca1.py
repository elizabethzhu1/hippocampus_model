...
class CA1_WilsonCowan:
    def __init__(self, wEE, wEI, wIE, wII, tau_E, tau_I, a_E, a_I, theta_E, theta_I, rE_init, rI_init, dt, range_t, ext_E, ext_I, T, tau_A, schaffer_input, is_adaptation=False, is_acetylcholine=False, is_theta_modulation=False):
        self.wEE = wEE 
        self.wEI = wEI
        self.wIE = wIE
        self.wII = wII
        ...
        self.T = T
        self.tau_A = tau_A
        self.schaffer_input = schaffer_input
    ...
    def simulate(self, **kwargs):
        ...
        # add theta modulation to external input
        # ext_E = self.theta_modulation(ext_E, 10)
        # ext_I = self.theta_modulation(ext_I, 10)
        ...
        # Set external inputs to be CA3 outputs + EC input
        ext_E = self.schaffer_input + self.EC_input()
        ext_I = self.schaffer_input + self.EC_input()
